# Starter Project for Phaser with Visual Studio Code and TypeScript

The following is a starter project to get started with a new game in Phaser and Visual Studio Code, using TypeScript.
